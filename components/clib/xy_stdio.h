...
/**
 * @brief Formatted print to string with variable arguments and size limit
 * @param buf  Output buffer
 * @param size Buffer size (including NUL terminator)
 * @param fmt  Format string
 * @param args Variable arguments
 * @return Number of characters written (not counting NUL), negative on error
 */
